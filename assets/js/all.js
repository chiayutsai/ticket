...
var ticketImgUrl = document.querySelector('#imgurl');
var ticketArea = document.querySelector('#area');
var ticketPrice = document.querySelector('#price');
...
function buildData(data) {
  var card = " <li class=\"col-md mb-7\">\n  <div class=\"card \">\n     <div class=\"card__head\">\n         <a href=\"\"><img class=\"card__img\"\n                 src=\"".concat(data.imgUrl, "\"\n                 alt=\"\"></a>\n         <div class=\"card__city\">").concat(data.area, "</div>\n         <div class=\"card__score\">").concat(data.rate, "</div>\n     </div>\n     <div class=\"card__body\">\n        <div>\n          <h2 class=\"card__title\">").concat(data.name, "</h2>\n          <div class=\"card__text\">\n           ").concat(data.description, "\n         </div>\n         </div>\n         <div class=\"d-flex justify-content-between align-items-center\">\n             <p class=\"text-primary font-medium lh-1\"><span class=\"material-icons pe-2\">\n                     error\n                 </span>\u5269\u4E0B\u6700\u5F8C ").concat(data.group, " \u7D44</p>\n             <p class=\"d-flex align-items-center text-primary font-medium\">TWD<span\n                     class=\"text-2xl ps-1\">").concat(data.price, "</span></p>\n         </div>\n     </div>\n </div>\n</li>");
  return card;
}
  ...
  if (area != '全部地區') {
    data.forEach(function (item) {
      if (item.area == area) {
        ...
        document.querySelector('.js-dataLength').innerHTML = "\u672C\u6B21\u641C\u5C0B\u5171".concat(searchData.length, "\u7B46\u8CC7\u6599");
      }
    });
  } else {
    searchData = data;
    document.querySelector('.js-dataLength').innerHTML = "\u5168\u90E8\u5171".concat(searchData.length, "\u7B46\u8CC7\u6599");
  }
...
function showData() {
  ...
  document.querySelector('.js-data').innerHTML = dataStr;
  document.querySelector('.js-dataLength').innerHTML = "\u5168\u90E8\u5171".concat(dataLength, "\u7B46\u8CC7\u6599");
}
